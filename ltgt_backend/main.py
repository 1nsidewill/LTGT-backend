...
@app.get('/favicon.ico')
async def get():
    return FileResponse(os.path.join(root, 'static', 'src', 'favicon.ico'))
...
if __name__ == '__main__':
    ...
    uvicorn.run('main:app', reload=True, log_level='debug',
                ssl_keyfile=os.path.join(root, 'static', 'key.pem'),
                ssl_certfile=os.path.join(root, 'static', 'cert.pem'))